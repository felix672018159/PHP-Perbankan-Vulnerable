<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    if($pesan){
      ...
      if(isset($login[1])){
        $cipher = enkripsi_caesar($login[4],$login[5],$login[1]);
        set_session($cipher);
        //echo $cipher."<br>";
      ...
      $spill_text = '<div class="pesan_sukses">'.
                    'Berhasil melakukan Login ... proses redirect ke halaman utama'
                    .'</div>';
    };
  }
...
<?php echo        '<input type="text" value="'.($a =isset($_POST['username'])? $_POST['username'] :'').'" name="username" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Username">' ?>
